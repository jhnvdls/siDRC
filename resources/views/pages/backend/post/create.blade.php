...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-white fw-bold lh-1">Create Posts</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
...
@section('content')
    <form id="form_input" class="form d-flex flex-column flex-lg-row" data-kt-redirect="{{ route('backend.posts.index') }}"
        action="{{ route('backend.posts.store') }}" method="POST" enctype="multipart/form-data">
        <!--begin::Aside column-->
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-10 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" name="excerpt"
                            placeholder="Excerpt" />
                        <!--end::Input-->
                        <!--begin::Description-->
