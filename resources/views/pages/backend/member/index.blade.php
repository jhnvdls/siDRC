...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
        ...
        <!--begin::Item-->
        <li class="breadcrumb-item text-white fw-bold lh-1">
            <a href="{{ route('backend.members.index') }}" class="text-white">All Members</a>
        </li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
    ...
    <div class="card card-flush">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                <!--begin::Add Facility-->
                <a href="{{ route('backend.members.create') }}" class="btn btn-primary" id="kt_toolbar_primary_button">
                    Add Member
                </a>
                <!--end::Add Facility-->
            </div>
        ...
        <div class="card-body pt-0">
            <div class="table-responsive">
                <!--begin::Table-->
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="member_table">
                    <!--begin::Table head-->
                    <thead>
                        <!--begin::Table row-->
...
@push('custom-scripts')
    <script>
        ...
        var KTAppEvent = function() {
                ...
                t.querySelectorAll('[data-filter="delete_row"]').forEach((t => {
                    t.addEventListener("click", (function(t) {
                        ...
                        Swal.fire({
                            ...
                            if (t.value) {
                                var url =
                                    "{{ route('backend.members.destroy', ':id') }}";
            ...
            return {
                init: function() {
                    (t = document.querySelector("#member_table")) && ((e = $(t).DataTable({
                            info: !1,
                            order: [],
                            pageLength: 10,
                            columnDefs: [{
