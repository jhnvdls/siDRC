...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-white fw-bold lh-1">Edit Member</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
@section('content')
    <form id="form_input" class="form d-flex flex-column flex-lg-row"
        data-kt-redirect="{{ route('backend.members.index') }}" action="{{ route('backend.members.update', $member->id) }}"
                ...
                <div class="card-body text-center pt-0">
                    ...
                    <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                        ...
                        <div class="image-input-wrapper w-150px h-150px">
                            <div class="image-input-wrapper w-150px h-150px"
                                style="background-image: url({{ asset('images/members/' . $member->image) }})">
                            </div>
                        </div>
                    ...
                    <div class="mb-10 fv-row">
                        ...
                        <select name="department_id" class="form-select form-select-solid" data-control="select2"
                            ...
                            @foreach ($departments as $department)
                                <option value="{{ $department->id }}" @if ($department->id == $member->department_id) selected @endif>
                    ...
                    <div class="mb-10 fv-row">
                        ...
                        <select name="position_id" class="form-select form-select-solid" data-control="select2"
                            ...
                            @foreach ($positions as $position)
                                <option value="{{ $position->id }}" @if ($position->id == $member->position_id) selected @endif>
